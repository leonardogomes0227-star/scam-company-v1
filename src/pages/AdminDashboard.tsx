...
import { 
  Package, Settings, Sparkles, Check, Copy, Layers, Clock, LogOut, 
  ArrowRight, ShieldCheck, Plus, Trash2, Edit2, Eye, MessageCircle, 
  DollarSign, Star, Ticket, ShoppingBag, Save, AlertCircle
} from 'lucide-react';
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="bg-slate-900 w-full max-w-md p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">Gerencie seus produtos, pedidos e cupons de desconto</p>
          </div>
